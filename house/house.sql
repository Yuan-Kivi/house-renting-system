...
CREATE TABLE `house` (
  ...
  `pre` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '押一付三|押一付一',
  `houseType` varchar(255) NOT NULL DEFAULT '租赁',
  `direction` varchar(255) NOT NULL DEFAULT '朝东',
  `room` varchar(255) NOT NULL DEFAULT '三室',
